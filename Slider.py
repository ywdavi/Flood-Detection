...
#st.subheader("Advanced Computational Techniques for Big Imaging and Signal Data")
...
"specifically designed to identify flood-induced damages in natural disaster scenarios. "
 "The segmentation model employed has been fine-tuned using the FloodNet dataset, which includes high-resolution"
 " aerial imagery. For additional information, please refer to the FloodNet GitHub repository "
...
if flooded_building_percentage > 2 or flooded_road_percentage > 2:
    container_response("rgba(255, 0, 0, 0.6)",
                       f"Automatically analyzed aerial image shows that {flooded_building_percentage:.2f}% of buildings and "
    ...
    container_response("rgba(0, 255, 0, 0.6)",
                       f"Automatically analyzed aerial image doesn't show any flood-induced damages")
